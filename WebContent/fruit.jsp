...
<body>
	...
	<h1 class="text-center my-4">All Fresh Fruits</h1>
				...
				<div class="card" style="width: 18rem;">
					...
					<div class="card-body">
						...
						<p class="card-text">
							...
							<%=price%></p>
						<a
							href="cart.jsp?pname=<%=name%>&price=<%=price%>&description=<%=description%>&image=<%=imageUrl%>"
							class="btn btn-primary">Add to Cart</a> <a href="checkout.jsp"
