...
<head>
    ...
    <style>
        ...
        @keyframes typing {
            ...
            50% { width: 100%; } /* Typing effect reaches full width */
            100% { width: 0; } /* Reset the width for the next loop */
        }
...
<body>
    ...
    <div class="jumbotron text-center">
        <div class="typewriter">
            <h1>Welcome to RevShop, <%= user.getName() %>!</h1>
        </div>
        <p class="lead">Shop the best products across a wide variety of categories at unbeatable prices!</p>
        <a href="allproduct.jsp" class="btn btn-primary btn-lg">Start Shopping</a>
    </div>
