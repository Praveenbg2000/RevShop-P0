...
<h1 class="text-center my-4">All Vegitables</h1>
    ...
    <div class="row">
        <%
            ...
            try {
                ...
                String sql = "SELECT * FROM productveg";
        ...
        <div class="col-md-3 mb-4">
            <div class="card" style="width: 18rem;">
                <img class="card-img-top" src="image/<%= imageUrl %>" alt="<%= name %> Image" style="width: 100%; height: 200px; object-fit: cover;">
                <div class="card-body">
